...
GLmol.prototype.create = function(id, suppressAutoload) {
   this.Nucleotides = ['  G', '  A', '  T', '  C', '  U', '  G', ' DA', ' DT', ' DC', ' DU'];
   this.ElementColors = {"H": 0xDDDDDD, "C": 0x888888, "O": 0xCC0000, "N": 0x0000CC, "S": 0xCCCC00, "P": 0x6622CC,
                         "F": 0x00CC00, "Cl": 0x00CC00, "CL": 0x00CC00, "Br": 0x882200, "BR": 0x882200, "I": 0x6600AA,
                         "Se": 0xC9B752,"K": 0xBD4BBD, "Na": 0x4462C3, "U": 0x438EDB, "Hg":0x849DB6, "HG":0x849DB6,
                        "Fe": 0xCC6600, "Ca": 0x8888AA, "CA": 0x8888AA, "Al": 0xAEAFC1};
// Reference: A. Bondi, J. Phys. Chem., 1964, 68, 441.
   this.vdwRadii = {"H": 1.2, "Li": 1.82, "Na": 2.27, "K": 2.75, "C": 1.7, "N": 1.55, "O": 1.52, "U":1.86,
                   "F": 1.47, "P": 1.80, "S": 1.80, "Cl": 1.75, "CL": 1.75, "Br": 1.85, "BR": 1.85, "Se": 1.90, "SE": 1.90,
                   "Hg": 1.32, "HG": 1.32, "Zn": 1.39, "ZN": 1.39, "Cu": 1.4, "CU": 1.4, "Ni": 1.63, "NI": 1.63, "Fe": 1.56, 
                   "I": 1.98, "Ca": 1.90, "Al": 1.52};
...
GLmol.prototype.drawBondsAsStick = function(group, atomlist, bondR, atomR, ignoreNonbonded, multipleBonds, scale) {
   ...
   for (var _i = 0; _i < nAtoms; _i++) {
      ...
      // Always display sphere, even if not connected
...
GLmol.prototype.colorByPolarity = function(atomlist, polar, nonpolar) {
   ...
   var nonPolarResidues = ['GLY', 'PRO', 'xLA', 'VxL', 'LEU', 'ILE', 'MET', 'PHE', 'TYR', 'TRP'];
   var colorMap = {};
