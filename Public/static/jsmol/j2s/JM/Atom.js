...
var flags = (this.formalChargeAndFlags & 4080) >> 4;
if (flags == 0 && this.atomicAndIsotopeNumber > 1 && doCalculate) {
flags = this.group.chain.model.ms.getAtomCIPChirality (this);
...
function () {
return (this.formalChargeAndFlags & 4080) >> 4;
});
