...
if (type != 1312817669 && type != 1073741864) return qBest.toString ();
...
Clazz.defineMethod (c$, "getBondCIPChirality", 
function (bond) {
this.haveChirality = true;
return J.api.Interface.getSymmetry (this.vwr, "ms").getBondCIPChirality (this.vwr, bond);
}, "JM.Bond");
Clazz.defineMethod (c$, "getAtomCIPChirality", 
function (atom) {
this.haveChirality = true;
return J.api.Interface.getSymmetry (this.vwr, "ms").getAtomCIPChirality (this.vwr, atom);
}, "JM.Atom");
